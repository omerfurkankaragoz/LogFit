...
const Auth: React.FC = () => {
  const handleLogin = async () => {
    try {
      // DÜZELTME: Google'ın hesap seçme ekranını her zaman göstermesi için
      // 'prompt: select_account' opsiyonu eklendi.
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-center items-center p-4">
      <div className="text-center">
        ...
        <button
          onClick={handleLogin}
          className="bg-blue-600 text-white font-semibold py-3 px-8 rounded-lg shadow-lg hover:bg-blue-700 transition-all duration-300 flex items-center justify-center gap-3 mx-auto"
        >
