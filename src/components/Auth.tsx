      ...
      <div className="w-full max-w-sm text-center">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
                type="submit"
                disabled={loading}
                className="w-full bg-system-blue text-white font-semibold py-3 px-8 rounded-xl shadow-md hover:opacity-90 transition-opacity active:scale-95 flex items-center justify-center gap-3 text-lg"
            >
        ...
        <div className="text-center my-6 text-sm">
            {authMode === 'login' ? (
              <p className="text-system-label-secondary">
                Hesabın yok mu?{' '}
                <button onClick={() => setAuthMode('signup')} className="text-system-blue hover:underline font-medium">
                  Kaydol
                </button>
              </p>
            ) : (
              <p className="text-system-label-secondary">
                ...
                <button onClick={() => setAuthMode('login')} className="text-system-blue hover:underline font-medium">
                  Giriş Yap
                </button>
              </p>
            )}
        ...
        <div className="space-y-3">
            <button
                ...
                disabled={loading}
                className="w-full bg-system-green text-white font-semibold py-3 px-8 rounded-xl shadow-md hover:opacity-90 transition-opacity active:scale-95 flex items-center justify-center gap-3"
            >
            ...
            <button
                ...
                disabled={loading}
                className="w-full bg-system-fill text-system-label font-semibold py-3 px-8 rounded-xl shadow-md hover:opacity-90 transition-opacity active:scale-95 flex items-center justify-center gap-3"
            >
