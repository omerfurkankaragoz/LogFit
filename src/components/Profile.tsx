...
import { Settings, LogOut, Plus, X } from 'lucide-react';
...
const Profile: React.FC<ProfileProps> = ({ session, onLogout }) => {
  ...
  return (
    <div>
        <div className="sticky top-[env(safe-area-inset-top)] z-10 bg-system-background/95 backdrop-blur-md pt-4 pb-4 px-4 flex justify-between items-center">
