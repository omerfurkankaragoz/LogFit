    ...
    return (
      <div className="p-4">
        <div className="flex items-center justify-center py-12">
          ...
          <span className="ml-2 text-gray-600">Hareketler yükleniyor...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-4">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-xl font-bold text-gray-800">Hareket Kütüphanesi</h2>
      </div>
      ...
      <div className="space-y-4 mb-6">
        ...
        {showFilters && (
          <div className="bg-white rounded-lg p-4 border border-gray-200">
            <h3 className="font-medium text-gray-800 mb-3">Vücut Bölgesi</h3>
